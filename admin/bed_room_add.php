              ...
              <form action="" method="post" name="myform" id="myform" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="bed_rooms_name" class="form-control" id="bed_rooms_name">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Bed Room Url</label>
                      <input type="text" name="bed_rooms_url" class="form-control" id="bed_rooms_url">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Bed Room Description</label>
                      <textarea id="bed_rooms_description" name="bed_rooms_description" class="form-control" rows="4"></textarea>
                    </div>
                  </div>
                </div>
                <hr class="mb-4">
                ...
                <div class="clearfix">
                  <div class="float-right">
                    ...
                    <input type="submit" name="bedRoomAdd" value="SAVE" class="btn btn-success">
                  </div>
                </div>
                <hr class="mb-4">
              </form>
