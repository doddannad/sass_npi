              ...
              <form action="" method="post" name="myform" id="myform">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="country_url" class="form-control" id="country_url">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea id="country_description" name="country_description" class="form-control" rows="4"></textarea>
                    </div>
                  </div>
                </div>
                <hr class="mb-4">
                ...
                <div class="clearfix">
                  <div class="float-right">
                    ...
                    <input type="submit" name="countryAdd" value="SAVE" class="btn btn-success">
                  </div>
                </div>
                <hr class="mb-4">
              </form>
