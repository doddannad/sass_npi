      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><i class="fa fa-plus"></i> New Price Sheet</h1>
          </div><hr>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control builders_name" name="builders_name" id="builders_name" onchange="fetchProject(this.value);">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control project_name" name="project_name" id="project_name">
                        <option value="">Select</option>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <table class="table table-bordered" id="add_more_field">
                      ...
                      <td>
                        <input name="sqft[]0" type="text" class="form-control sqft" placeholder="Enter Sqft">
                      </td>
                      <td>
                        <input type="text" name="price_amount[]0" class="form-control price_amount" placeholder="Enter Price">
                      </td>
                  ...
                  <div class="clearfix">
                    <div class="float-right">
                      ...
                      <input type="submit" name="priceSheetAdd" value="SAVE" class="btn btn-success">
                    </div>
                  </div>                
              </form>
            </div>
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      function addMoreRows() {
        $('#add_more_field').append($('<tr><td><select name="units_type[]'+i+'" class="form-control units_type"><option value="">Select Bed Room</option><?php foreach ($bedRoomsArray as $bedRooms){?><option value="<?php echo $bedRooms['bed_rooms_id']; ?>"><?php echo $bedRooms['bed_rooms_name']; ?></option><?php }?></select></td><td><input name="sqft[]'+i+'" type="text"  class="form-control sqft" placeholder="Enter Sqft"></td><td><input type="text" name="price_amount[]'+i+'" class="form-control price_amount" placeholder="Enter Price"></td><td style="text-align: center;"><button class="btn btn-danger sm remove"><i class="fa fa-minus"></i></button></td></tr>'));
        i++;
      }
