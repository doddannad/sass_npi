      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><i class="fa fa-plus"></i> New Specifications</h1>
          </div><hr>
                      ...
                      <select class="form-control" name="project_name" id="project_name">
                        ...
                        foreach ($projects as $project) {?>
                          <option value="<?php echo $project['project_id'] ?>">
                            <?php echo $project['project_name2'] ?>
                          </option>
                        <?php }?>
                      </select>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <table class="table table-bordered" id="add_more_field">
                      ...
                      <tr>
                        <td><input type="text" name="specification_name[]" class="form-control" placeholder="Specification Name"></td>
                        <td><textarea class="form-control" name="specification_description[]" placeholder="Describe Specification"></textarea></td>
                      </tr>
                    </table>
                  </div>
                </div><hr class="mb-4">
                  ...
                  <div class="clearfix">
                    <div class="float-right">
                      ...
                      <input type="submit" name="specificationAdd" value="SAVE" class="btn btn-success">
                    </div>
                  </div>                
              </form>
            </div>
