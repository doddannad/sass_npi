      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><i class="fa fa-plus"></i> New Amenities</h1>
          </div><hr>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <table class="table table-bordered" id="add_more_field">
                      ...
                      <tr>
                        <td>
                          <input type="text" name="amenitiesName[]" class="form-control" placeholder="Enter Amenities">
                        </td>
                  ...
                  <div class="clearfix">
                    <div class="float-right">
                      ...
                      <input type="submit" name="amenitiesAdd" value="SAVE" class="btn btn-success">
                    </div>
                  </div>                
              </form>
            </div>
