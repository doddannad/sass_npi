...
if (!empty($url1 && $url2 && $url3)) {
  ...
  WHERE pd.city_id=ct.city_id AND pd.property_types_id=pt.property_types_id AND br.bed_rooms_id=uc.unit_types_id AND pd.project_id=uc.project_id AND ct.city_url='$url1' AND pt.property_types_url='$url2' AND br.bed_rooms_url='$url3' ");
